...
- Don't create placeholder or stubbed out code, always fully implement any code needed.
...
- Make the app easy to use so that any user needs no training.  Use tooltips and context sensitive help where needed.
- Make the app visually appealing with relevant icons and graphics.