...
class APIController(QObject):
    ...
    def get_active_incidents(self) -> List[Dict[str, Any]]:
        ...
        """
        return self.incident_dao.find_active(as_dict=True)
    ...
    def close_incident(self, incident_id: int) -> bool:
        ...
        """
        success = self.incident_dao.set_incident_closed(incident_id)
    ...
    def reopen_incident(self, incident_id: int) -> bool:
        ...
        """
        success = self.incident_dao.set_incident_active(incident_id)
    ...
    def get_incident_stats(self) -> Dict[str, int]:
        ...
        """
        return self.incident_dao.find_incident_stats()
    ...
    def update_form_status(self, form_id: int, status: Union[FormStatus, str]) -> bool:
        ...
        """
        success = self.form_dao.set_form_status(form_id, status)
    ...
    def search_forms(self, search_term: str, incident_id: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        """
        return self.form_dao.search(search_term, incident_id, form_type=None)
    ...
    def get_recent_forms(self, limit: int = 10, incident_id: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        """
        return self.form_dao.find_recent(as_dict=True, limit=limit, incident_id=incident_id)
    ...
    def get_user_by_call_sign(self, call_sign: str) -> Optional[Dict[str, Any]]:
        ...
        Returns:
            User data dictionary if found, None otherwise
        """
        return self.user_dao.find_by_call_sign(call_sign, as_dict=True)
    ...
    def get_setting(self, key: str, default: Any = None) -> Any:
        ...
        """
        return self.setting_dao.find_value(key, default)
    ...
    def get_settings_by_prefix(self, prefix: str) -> Dict[str, Any]:
        ...
        """
        return self.setting_dao.find_as_dict(prefix)
    ...
    def get_attachments_for_form(self, form_id: int) -> List[Dict[str, Any]]:
        ...
        """
        return self.attachment_dao.find_by_form(form_id, as_dict=True)
    ...
    def get_attachment_info(self, attachment_id: int) -> Optional[Dict[str, Any]]:
        ...
        """
        return self.attachment_dao.find_attachment_info(attachment_id)
